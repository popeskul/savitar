<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Run build, server and file tracking</td>
    </tr>
    <tr>
      <td><code>npm start TASK</code></td>
      <td>Run a task called TASK (task list in <code>gulpfile.js</code>)</td>
    </tr>
    <tr>
      <td><code>npm run build</code></td>
      <td>Building a project without code cards (concise view as a result of work)</td>
    </tr>
    <tr>
      <td><code>npm run deploy</code></td>
      <td>Assembling a project without code cards and sending the contents of the assembly folder to github-pages (to correctly display the viewing address, enter it in <code>./package.json</code>)</td>
    </tr>
    <tr>
      <td><code>npm run test:style</code></td>
      <td>Checking the style component of the project <a href="https://stylelint.io/">stylelint</a></td>
    </tr>
    <tr>
      <td><code>npm run test:orpho</code></td>
      <td>Search for errors and typos in <code>.html</code> и <code>.md</code> files in <code>./src</code> via <a href="https://github.com/hcodes/yaspeller">yaspeller</a></td>
    </tr>
  </tbody>
</table>

If nothing happens when calling `npm start`, see`./projectConfig.json`, it contains a syntax error. You can check [linter](http://jsonlint.com/)
